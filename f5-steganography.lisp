...
(defun print-usage ()
  ...
  (format t "  input_filename : path to the input file~%")
  (format t "  option :~%")
  (format t "    h : hide message~%")
  (format t "    e : extract message~%")
  (format t "  message_filename : path to file containing the message to hide or extract to~%")
